...
class Tg
{
    ...
    /**
     * Setup a Telegram class from the bot token
    ...
    public static function setup($bot_token, $log_errors = true, array $proxy = [])
    {
    ...
    public static function endpoint($api, array $content, $post = true)
    {

        $url = 'https://api.telegram.org/bot' . self::$bot_token . '/' . $api;
...
/// A method for testing your bot.
...

    {
        ...
        return self::endpoint('getMe', [], false);
...
/// A method for responding http to Telegram.
...

    {
        ...
        return self::endpoint('sendMessage', $content);
    ...
    public static function forwardMessage(array $content)

    {

        return self::endpoint('forwardMessage', $content);
    ...
    public static function sendPhoto(array $content)

    {

        return self::endpoint('sendPhoto', $content);
    ...
    public static function sendAudio(array $content)

    {

        return self::endpoint('sendAudio', $content);
    ...
    public static function sendDocument(array $content)

    {

        return self::endpoint('sendDocument', $content);
    ...
    public static function sendAnimation(array $content)

    {

        return self::endpoint('sendAnimation', $content);
    ...
    public static function sendSticker(array $content)

    {

        return self::endpoint('sendSticker', $content);
    ...
    public static function sendVideo(array $content)

    {

        return self::endpoint('sendVideo', $content);
    ...
    public static function sendVoice(array $content)

    {

        return self::endpoint('sendVoice', $content);
    ...
    public static function sendLocation(array $content)

    {

        return self::endpoint('sendLocation', $content);
    ...
    public static function editMessageLiveLocation(array $content)

    {

        return self::endpoint('editMessageLiveLocation', $content);
    ...
    public static function stopMessageLiveLocation(array $content)

    {

        return self::endpoint('stopMessageLiveLocation', $content);
    ...
    public static function setChatStickerSet(array $content)

    {

        return self::endpoint('setChatStickerSet', $content);
    ...
    public static function deleteChatStickerSet(array $content)

    {

        return self::endpoint('deleteChatStickerSet', $content);
    ...
    public static function sendMediaGroup(array $content)

    {

        return self::endpoint('sendMediaGroup', $content);
    ...
    public static function sendVenue(array $content)

    {

        return self::endpoint('sendVenue', $content);
    ...
    public static function sendContact(array $content)

    {

        return self::endpoint('sendContact', $content);
    ...
    public static function sendChatAction(array $content)

    {

        return self::endpoint('sendChatAction', $content);
    ...
    public static function getUserProfilePhotos(array $content)

    {

        return self::endpoint('getUserProfilePhotos', $content);
...

    {
        ...
        return self::endpoint('getFile', $content);
    ...
    public static function kickChatMember(array $content)

    {

        return self::endpoint('kickChatMember', $content);
    ...
    public static function leaveChat(array $content)

    {

        return self::endpoint('leaveChat', $content);
    ...
    public static function unbanChatMember(array $content)

    {

        return self::endpoint('unbanChatMember', $content);
    ...
    public static function getChat(array $content)

    {

        return self::endpoint('getChat', $content);
    ...
    public static function getChatAdministrators(array $content)

    {

        return self::endpoint('getChatAdministrators', $content);
    ...
    public static function getChatMembersCount(array $content)

    {

        return self::endpoint('getChatMembersCount', $content);
    ...
    public static function getChatMember(array $content)

    {

        return self::endpoint('getChatMember', $content);
    ...
    public static function answerInlineQuery(array $content)

    {

        return self::endpoint('answerInlineQuery', $content);
    ...
    public static function setGameScore(array $content)

    {

        return self::endpoint('setGameScore', $content);
    ...
    public static function answerCallbackQuery(array $content)

    {

        return self::endpoint('answerCallbackQuery', $content);
    ...
    public static function editMessageText(array $content)

    {

        return self::endpoint('editMessageText', $content);
    ...
    public static function editMessageCaption(array $content)

    {

        return self::endpoint('editMessageCaption', $content);
    ...
    public static function editMessageReplyMarkup(array $content)

    {

        return self::endpoint('editMessageReplyMarkup', $content);
    ...
    public static function downloadFile($telegram_file_path, $local_file_path)

    {

        $file_url = 'https://api.telegram.org/file/bot' . self::$bot_token . '/' . $telegram_file_path;
    ...
    public static function setWebhook($url, $certificate = '')

    {
        ...
        return self::endpoint('setWebhook', $requestBody, true);
...

    {
        ...
        return self::endpoint('deleteWebhook', [], false);
    ...
    public static function ReplyToMessageID()
    ...
    public static function ReplyToMessageFromUserID()
    ...
    public static function Inline_Query()
    ...
    public static function Callback_Query()
    ...
    public static function Callback_ID()
    ...
    public static function Callback_Data()
    ...
    public static function Callback_Message()
    ...
    public static function Callback_ChatID()
...

    {
        ...
        return count(self::$updates['result']);
    ...
    public static function FromChatID()
    ...
    public static function messageFromGroup()
    ...
    public static function messageFromGroupTitle()
    ...
    public static function buildKeyBoard(array $options, $onetime = false, $resize = false, $selective = true)
    ...
    public static function buildInlineKeyBoard(array $options)
    ...
    public static function buildInlineKeyboardButton($text, $url = '', $callback_data = '', $switch_inline_query = null, $switch_inline_query_current_chat = null, $callback_game = '', $pay = '')
    ...
    public static function buildKeyboardButton($text, $request_contact = false, $request_location = false, $request_poll = "")

    {
        ...
        if ($request_poll != null) {
            $keyboardButton['request_poll'] = ["type" => $request_poll];
        }
    ...
    public static function buildKeyBoardHide($selective = true)
    ...
    public static function buildForceReply($selective = true)
    ...
    public static function sendInvoice(array $content)

    {

        return self::endpoint('sendInvoice', $content);
    ...
    public static function answerShippingQuery(array $content)

    {

        return self::endpoint('answerShippingQuery', $content);
    ...
    public static function answerPreCheckoutQuery(array $content)

    {

        return self::endpoint('answerPreCheckoutQuery', $content);
    ...
    public static function sendVideoNote(array $content)

    {

        return self::endpoint('sendVideoNote', $content);
    ...
    public static function restrictChatMember(array $content)

    {

        return self::endpoint('restrictChatMember', $content);
    ...
    public static function promoteChatMember(array $content)

    {

        return self::endpoint('promoteChatMember', $content);
    ...
    public static function exportChatInviteLink(array $content)

    {

        return self::endpoint('exportChatInviteLink', $content);
    ...
    public static function setChatPhoto(array $content)

    {

        return self::endpoint('setChatPhoto', $content);
    ...
    public static function deleteChatPhoto(array $content)

    {

        return self::endpoint('deleteChatPhoto', $content);
    ...
    public static function setChatTitle(array $content)

    {

        return self::endpoint('setChatTitle', $content);
    ...
    public static function setChatDescription(array $content)

    {

        return self::endpoint('setChatDescription', $content);
    ...
    public static function pinChatMessage(array $content)

    {

        return self::endpoint('pinChatMessage', $content);
    ...
    public static function unpinChatMessage(array $content)

    {

        return self::endpoint('unpinChatMessage', $content);
    ...
    public static function getStickerSet(array $content)

    {

        return self::endpoint('getStickerSet', $content);
    ...
    public static function uploadStickerFile(array $content)

    {

        return self::endpoint('uploadStickerFile', $content);
    ...
    public static function createNewStickerSet(array $content)

    {

        return self::endpoint('createNewStickerSet', $content);
    ...
    public static function addStickerToSet(array $content)

    {

        return self::endpoint('addStickerToSet', $content);
    ...
    public static function setStickerPositionInSet(array $content)

    {

        return self::endpoint('setStickerPositionInSet', $content);
    ...
    public static function deleteStickerFromSet(array $content)

    {

        return self::endpoint('deleteStickerFromSet', $content);
    ...
    public static function deleteMessage(array $content)

    {

        return self::endpoint('deleteMessage', $content);
    ...
    public static function getUpdates($offset = 0, $limit = 100, $timeout = 0, $update = true)

    {

        $content = ['offset' => $offset, 'limit' => $limit, 'timeout' => $timeout];

        self::$updates = self::endpoint('getUpdates', $content);

        if ($update) {

            if (is_array(self::$updates['result']) && count(self::$updates['result']) >= 1) { //for CLI working.

                $last_element_id = self::$updates['result'][count(self::$updates['result']) - 1]['update_id'] + 1;

                $content = ['offset' => $last_element_id, 'limit' => '1', 'timeout' => $timeout];

                self::endpoint('getUpdates', $content);
    ...
    public static function serveUpdate($update)

    {

        self::$data = self::$updates['result'][$update];
    ...
    private static function sendAPIRequest($url, array $content, $post = true)

    {
        ...
        if (!empty(self::$proxy)) {
            ...
            if (array_key_exists('type', self::$proxy)) {
            ...
            if (array_key_exists('auth', self::$proxy)) {

                curl_setopt($ch, CURLOPT_PROXYUSERPWD, self::$proxy['auth']);

            }


            if (array_key_exists('url', self::$proxy)) {

                // 				echo "Proxy Url";

                curl_setopt($ch, CURLOPT_PROXY, self::$proxy['url']);

            }


            if (array_key_exists('port', self::$proxy)) {
        ...
        if (self::$log_errors) {
            ...
            $loggerArray = (self::getData() == null) ? [$content] : [self::getData(), $content];
